...
export default function BotblyNudge({
    initialDelay = 1400,
    desktopMessage = "The chat is open. Ask about hours, services, or reservations.",
    mobileMessage = "Tap the chat button to start. Ask about hours, services, or reservations.",
    ...
    const onPrimary = () => {
        dismiss();
        if (!isMobile) {
            sendToBot("Hi, can I reserve a table for next Saturday evening?");
        }
    };
        ...
        <div className="fixed inset-0 z-[2147483647] flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-[92%] max-w-md sm:max-w-lg p-5 sm:p-6 text-center">
                <h3 className="text-lg sm:text-2xl font-semibold text-gray-900">
                    The assistant is ready to test
                </h3>
